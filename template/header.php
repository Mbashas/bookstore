...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color: #00a3cc; height: 80px;">
      <a class="navbar-brand" href="#">
        <img src="./bootstrap/img/5.png" alt="Logo" style="height:80px;">
    </a>
    </a>
      <div class="container">
        <div class="navbar-header" style="background-color: #00a3cc;">
